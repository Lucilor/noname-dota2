game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"Dota2",content:function (config,pack){
        ...
        game.import('character',function(lib,game,ui,get,ai,_status){
            var Dota2Pack = {
                ...
                character:{
                    ...
                    "d2_abaddon":["male","wei",4,["d2_andun","d2_fanzhao"],[]],
                    "d2_terrorBlade":["male","shu",4,["d2_hunduan","d2_daoying","d2_mohua"],[]],
                    "d2_mage":["female","shen",3,["d2_aomi","d2_yongheng"],["forbidai"]],
                    "d2_boss_mage":["none","shen",7,["d2_boss_aomi","d2_boss_yongheng","d2_boss_chongzheng"],["boss","forbidai","bossallowed","chongzheng"],3],
                    "d2_megaCreep":["none","shen",5,["d2_baiban"],["forbidai","unseen"]],
                    ...
                    "d2_oracle":["male","wei",3,["d2_diyan","d2_xunuo"],["forbidai"]],
                    ...
                    "d2_supernova":["none","shu",2,["d2_hengxing","d2_niepan"],["forbidai","unseen"]],
                    ...
                    "d2_outworldDevourer":["male","wei",3,["d2_tianqiu","d2_jingqi","d2_shizhi"],[]],
                ...
                skill:{
                    ...
                    "d2_bingfeng":{
                        ...
                        content:function (){
                            trigger.source.addTempSkill('d2_bingfeng2',{player:'phaseBegin'});
                        },
                        ai:{
                            threaten:0.7,
                            expose:0.1,
                    ...
                    "d2_bingjian":{
                        ...
                        content:function (){
                            if (trigger.card.vanishtag.contains('d2_jianyu')) {
                    ...
                    "d2_kuangfeng":{
                        ...
                        content:function (){
                            player.addTempSkill('d2_kuangfeng_effect',{player:'phaseBegin'});
                        },
                        ai:{
                            order:1,
                            result:{
                    ...
                    "d2_jiban":{
                        ...
                        content:function(){
                            ...
                            if (result.bool) {
                                ...
                                game.playAudio("Dota2","skill","d2_jiban");
                            }
                        },
                        group:'d2_jiban_sync',
                        subSkill:{
                    ...
                    "d2_shenbi":{
                        ...
                        content:function(){
                            ...
                            var cards=lib.card.list;
                            var list=[];
                            for(i in cards) {
                                var name=cards[i][2];
                                var length=get.translation(name).length;
                                if(name==undefined||list.contains(name)) continue;
                                if(get.value(game.createCard(name))<=player.getEquip('d2_aghanims')?6:0) continue;
                                if(length==num||num==4&&length>num) {
                                    list.push(name);
                                }
                            }
                            var num2=Math.ceil((13/num-1)*Math.random());
                    ...
                    "d2_fuhun":{
                        ...
                        position:'he',
                        filter:function(event,player){
                            return player.countCards('he',{color:'black'})>1&&!game.hasPlayer(function(current){
                    ...
                    "d2_judu":{
                        ...
                        line:"thunder",
                        content:function(){
                            var num=player.getEquip('d2_aghanims')?3:2;
                            ...
                            game.log(target,'将'+get.cnNumber(cards.length)+'张手牌转化为',{name:'du'});
                        },
                        contentAfter:function (){
                        ...
                        subSkill:{
                            ...
                            "clear":{
                                ...
                                content:function(){
                                    ...
                                    if(player.getEquip('d2_aghanims')) player.recover(player.storage.d2_ganran);
                                    player.storage.d2_ganran=0;
                                },
                                sub:true,
                            },
                                ...
                                content:function(){
                                    ...
                                    for(var i=0;i<undying.length;i++){
                                        ...
                                        if(undying[i].storage.d2_ganran>=3) {
                                            immune=true;
                                            undying[i].addTempSkill('d2_ganran_immune',{player:'phaseEnd'});
                                        }
                                    }
                                    if(undying.length>0){
                    ...
                    "d2_guore":{
                        ...
                        content:function(){
                            ...
                            var num=0;
                            if(player.getEquip('d2_aghanims')) num++;
                        ...
                        subSkill:{
                            "mark":{
                                ...
                                content:function(){
                                    ...
                                    if (event.source&&event.source.hasSkill('d2_longdu')&&event.num>0) {
                            ...
                            "2":{
                                ...
                                forced:true,
                                filter:function(event,player){
                                    return event.player.storage.d2_longdu_mark>4;
                                },
                                content:function(){
                                    'step 0'
                                    event.list=trigger.targets;
                                    'step 1'
                                    if(event.list.length){
                                        event.current=event.list.shift();
                                        var cards=event.current.getCards('he',function(card){
                                            return get.type(card)=='equip'&&get.subtype(card)=='equip2';
                                        });
                                        if(cards.length) event.current.discard(cards);
                                    }
                                    else{
                                        event.finish();
                                    }
                            ...
                            "3":{
                                ...
                                forced:true,
                                filter:function(event,player){
                                    return event.player.storage.d2_longdu_mark>0&&Math.floor(Math.random()*100)<event.player.storage.d2_longdu_mark*20;
                                },
                                content:function(){
                    ...
                    "d2_fengxing":{
                        ...
                        content:function(){
                            player.addTempSkill('d2_fengxing_shan',{player:'phaseBegin'});
                        },
                        subSkill:{
                            "shan":{
                                audio:"ext:Dota2:2",
                        ...
                        subSkill:{
                            "use":{
                                ...
                                ai:{
                                    order:function(){
                                        var player=_status.event.player;
                                        if (player.hasSkill('d2_bingjian')) return get.order({name:'sha'})+0.1;
                                        return get.order({name:'sha'})-0.1;
                                    },
                                    result:{
                                        player:1,
            ...
            if(lib.device||lib.node){
                for(var i in Dota2Pack.character){Dota2Pack.character[i][4].push('ext:Dota2/image/character/'+i+'.jpg');}
            } else {
    ...
    "announcer":{"name":"连杀配音","init":"default","item":{"default":"默认","crystalMaiden":"水晶室女","monkeyKing":"齐天大圣","kunkka":"昆卡","tideHunter":"潮汐猎人","disable":"关闭"},"intro":"选择连杀配音"},
