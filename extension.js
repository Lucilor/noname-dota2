        ...
        skill:{
            ...
            "_d2_firstBlood":{
                ...
                content:function (){
                    ...
                    game.log(get.translation(player)+'拿下了第一滴血！');
            ...
            "_d2_doubleKill":{
                ...
                forced:true,
                content:function (){
                    game.log(get.translation(player)+'拿下了双杀！')
            ...
            "_d2_tripleKill":{
                ...
                forced:true,
                content:function (){
                    game.log(get.translation(player)+'拿下了三杀！')
            ...
            "_d2_ultraKill":{
                ...
                forced:true,
                content:function (){
                    game.log(get.translation(player)+'正在疯狂杀戮！')
            ...
            "_d2_rampage":{
                ...
                forced:true,
                content:function (){
                    game.log(get.translation(player)+'已经暴走啦！')
            ...
            "d2_junheng":{
                ...
                content:function (){
                    ...
                    game.log(get.translation(target)+'被均衡了。');
                },
                ai:{
                    expose:0.4,
                },
            ...
            "d2_hunduan":{
                ...
                content:function (){
                    ...
                    player.update();
                    target.update();
                    game.log(get.translation(player)+'与'+get.translation(target)+'的体力值交换了。');
                    if(player.getEquip('d2_aghanims')){
                        if(hp>target.hp){
            ...
            "d2_baiban":{
                ...
                content:function(){
                    ...
                    event.toRespond=game.filterPlayer(function(current){
                        return get.distance(player,current)<=1&&current.countCards('h');
                    });
                    event.cards=[];
                    'step 1'
        ...
        skill:{
            ...
            "d2_tianqiu":{
                ...
                content:function(){
                    ...
                    var num1=player.countCards('h')+player.storage.d2_tianqiu;
                    var num2=trigger.player.countCards('h');
                    var check=player.getEquip('d2_aghanims');
                    var num=2;
                    if(check) num=1;
                    if(num1>num2&&player.countCards('he')>=num) {
                        event.damage=true;
                        ...
                        if(check&&trigger.player.countCards('he')) player.gainPlayerCard('奥术天球：获得'+get.translation(trigger.player)+'一张手牌',trigger.player,'h',true);
                        else player.draw();
                    }
                    'step 1'
